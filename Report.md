...
The metabolome analysis was challenging because a few features were annotated (1666 features in total, more or less 430 identified and named based on GNPS database, and more or less 215 features depend on the plant, after duplicates were removed compound name associated). Nevertheless, these results show interesting differences between the reported phylogeny of the Salvia species and their metabolome. However, to reduce the sampling bias and to consolidate the results obtain, new species of Salvia must be analyse. Additionnaly, other extraction methods could be tested and optimized, to increase the quantity and the variety of metabolites which could end up in better discriminate the different Salvia species. Finally, additional replicates would enable more robust statistical analysis and would benefit this study.
